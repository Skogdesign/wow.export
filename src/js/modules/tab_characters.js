				...
				<div class="character-export-container">
					<div class="character-export-controls">
						...
						<div class="character-export-menu" v-show="$core.view.chrExportMenu == 'settings'">
							...
							<label class="ui-checkbox" title="Synthetic normal/roughness/AO shading derived from the character skin and equipment textures">
								<input type="checkbox" v-model="$core.view.config.chrPBR"/>
								<span>PBR Shading</span>
							</label>
							<template v-if="$core.view.config.chrPBR">
