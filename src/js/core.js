...
const makeNewView = () => {
	return {
		...
		menuButtonModels: [
			...
			{ label: 'Export PNG Sequence (Animation)', value: 'PNG_SEQUENCE' },
			{ label: 'Export Turntable Sequence', value: 'TURNTABLE' },
			{ label: 'Export Render Passes (PNG)', value: 'PASSES' },
			{ label: 'Export UV Layout (PNG)', value: 'UV_OVERLAY' },
			{ label: 'Export Particle Sheets (PNG)', value: 'PARTICLE_SHEET' },
			{ label: 'Export Camera (AE jsx + JSON)', value: 'CAMERA_JSX' },
		],
